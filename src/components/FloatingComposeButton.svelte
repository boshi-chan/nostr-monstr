...
{#if shouldShow}
  <button
    ...
    class="fixed bottom-20 right-4 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-primary text-dark shadow-lg transition-all duration-200 hover:scale-105 hover:shadow-xl md:bottom-6 md:right-6 md:h-16 md:w-16"
    title="Compose"
